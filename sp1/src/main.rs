...
use sp1_sdk::{utils::BabyBearPoseidon2, SP1Prover, SP1Stdin, SP1Verifier};
use utils::{benchmark, size};

// const FIBONACCI_ELF: &[u8] = include_bytes!("../fibonacci/elf-compilation/riscv32im-succinct-zkvm-elf");
const SHA2_ELF: &[u8] = include_bytes!("../sha2/target/elf-compilation/riscv32im-succinct-zkvm-elf/release/sha2-bench");
...
fn benchmark_with_shard_size(func: fn(u32) -> BenchResult, iters: &[u32], shard_sizes: &[usize], file_name: &str, input_name: &str) {
